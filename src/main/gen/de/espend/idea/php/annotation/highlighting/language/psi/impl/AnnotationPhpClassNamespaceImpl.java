...
public class AnnotationPhpClassNamespaceImpl extends ASTWrapperPsiElement implements AnnotationPhpClassNamespace {

  public AnnotationPhpClassNamespaceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AnnotationPhpVisitor visitor) {
    visitor.visitClassNamespace(this);
  }
