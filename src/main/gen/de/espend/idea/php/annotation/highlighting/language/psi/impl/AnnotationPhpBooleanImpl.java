...
public class AnnotationPhpBooleanImpl extends ASTWrapperPsiElement implements AnnotationPhpBoolean {

  public AnnotationPhpBooleanImpl(@NotNull ASTNode node) {
    super(node);
  }
