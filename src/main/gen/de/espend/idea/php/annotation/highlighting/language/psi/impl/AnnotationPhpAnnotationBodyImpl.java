...
public class AnnotationPhpAnnotationBodyImpl extends ASTWrapperPsiElement implements AnnotationPhpAnnotationBody {

  public AnnotationPhpAnnotationBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public AnnotationPhpValues getValues() {
    return findChildByClass(AnnotationPhpValues.class);
  }
