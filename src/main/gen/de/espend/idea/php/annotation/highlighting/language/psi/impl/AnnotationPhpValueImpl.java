...
public class AnnotationPhpValueImpl extends ASTWrapperPsiElement implements AnnotationPhpValue {

  public AnnotationPhpValueImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public AnnotationPhpFieldAssignment getFieldAssignment() {
    return findChildByClass(AnnotationPhpFieldAssignment.class);
  }
