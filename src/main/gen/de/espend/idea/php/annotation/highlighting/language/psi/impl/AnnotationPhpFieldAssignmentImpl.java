...
public class AnnotationPhpFieldAssignmentImpl extends ASTWrapperPsiElement implements AnnotationPhpFieldAssignment {

  public AnnotationPhpFieldAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public AnnotationPhpPlainValue getPlainValue() {
    return findNotNullChildByClass(AnnotationPhpPlainValue.class);
  }
